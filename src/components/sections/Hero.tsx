...
export function Hero() {
  ...
  return (
    ...
    >
      <motion.div style={hydrated ? { y, scale } : undefined} className="absolute inset-0">
        {hydrated ? (
      ...
      <motion.div
        style={hydrated ? { opacity: fade } : undefined}
      ...
      >
        <h1 className="overflow-hidden">
          {hydrated ? (
            ...
            <span className="block font-display text-[clamp(2.55rem,11vw,7.4vw)] leading-[0.9] tracking-[-0.02em] sm:text-[9vw] lg:text-[7.4vw]">
              Elysium Hotels
            </span>
          )}
        </h1>
        ...
        <div className="mt-4 overflow-hidden sm:mt-5">
          {hydrated ? (
            ...
            <p className="max-w-md font-display text-xl text-ivory/80 sm:text-2xl lg:text-3xl">
              Luxury Reimagined
            </p>
          )}
        </div>
